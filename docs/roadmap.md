...
| **A15** | ⏳ **noté, à challenger avant de construire** *(idée PO 2026-07-30)* — **Fil d'actualité à la Strava en écran d'accueil** : un flux qui se déroule (« Martin a couru à Salbris », « tu as été rétrogradé Argent », « Sophie a battu le record du circuit »…) pour rendre l'app addictive et donner une raison de l'ouvrir sans course en cours. À l'analyse le moment venu : quels événements méritent le fil (courses d'amis, changements de grade, records, badges ?), fraîcheur (généré à la lecture vs table d'événements), respect des profils privés, et la place de l'onglet Courses actuel si l'accueil devient le fil. | idée PO |
| **A16** | ⏳ **en attente du fichier PO** *(2026-07-30)* — **Longueur des circuits & co** : le PO fournira un fichier (longueur de piste, etc. — données absentes d'OpenStreetMap : l'étude A11 avait mesuré 1/277 pour la longueur, 0/277 pour les cylindrées). À l'arrivée du fichier : rapprochement avec le référentiel (nom+ville normalisés), import, affichage sur la fiche circuit. **Action PO : transmettre le fichier.** | idée PO |
| **A17** | ⏳ **noté — proposition UX à préparer, décision ENSEMBLE** *(idée PO 2026-07-30)* — **Tout visible sans défiler** : le PO veut, autant que possible, des écrans qui tiennent d'un coup sur l'écran du téléphone, sans monter/descendre. Le moment venu : passage d'un agent UX designer écran par écran (densité, hiérarchie, ce qui se replie, ce qui saute) avec des propositions maquettées à arbitrer avec le PO — sans sacrifier la lisibilité ni les atouts existants. | idée PO |
