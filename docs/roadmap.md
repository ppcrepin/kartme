...
- **ODbL : remonter les corrections en amont.** Si un pilote signale un karting fermé ou mal nommé, la licence demande que la correction soit partagée — le plus simple étant de la porter dans OpenStreetMap. Canal à décider (voir `docs/credits.md`).
