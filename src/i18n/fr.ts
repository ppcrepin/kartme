...
export const fr = {
  ...
  badges: {
    title: 'Badges',
    subtitle: 'Dix trophées à décrocher sur la piste.',
    ...
    items: {
      ...
      kart_astrophe: { name: 'Kart-astrophe', condition: 'Perdre 48 points d’Elo ou plus en une course.' },
      lanterne_rouge: { name: 'Lanterne rouge', condition: 'Finir dernier d’une course (3 pilotes ou plus).' },
      tete_a_queue: { name: 'Tête-à-queue', condition: 'Perdre un palier de grade entier.' },
      deux_h_moins_le_kart: { name: 'Il est 2h moins le kart', condition: 'Course validée entre minuit et 5h.' },
      chef_ecurie: { name: 'Chef d’écurie', condition: 'Organiser 10 courses.' },
      david_goliath: { name: 'David contre Goliath', condition: 'Battre un pilote parti 300 Elo (ou plus) au-dessus de soi.' },
    },
  },
  settings: {
    title: 'Réglages',
